...
/**
 * 展开  收起   textView
 * Created by Winter.H on 2016/10/24.
 */
...
public class ExpandableTextView extends android.support.v7.widget.AppCompatTextView{
    ...
    private static final int MAX_LINES_ON_SHRINK = 2;//默认最多展示几行
    private static final int TO_EXPAND_HINT_COLOR = 0xFF20BF7A;//展开按钮颜色
    private static final int TO_SHRINK_HINT_COLOR = 0xFF20BF7A;//收起按钮颜色
